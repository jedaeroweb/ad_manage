...
Admin.create(:id=>3,:email => 'jpark1@jedaeroweb.co.kr',:name=>'Jon Doe1',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>4,:email => 'jpark2@jedaeroweb.co.kr',:name=>'Operator',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>5,:email => 'jpark5@jedaeroweb.co.kr',:name=>'SubOperator',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>6,:email => 'jpark4@jedaeroweb.co.kr',:name=>'Reader',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>7,:email => 'jpark6@jedaeroweb.co.kr',:name=>'Sponsor',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>8,:email => 'jpark4@mysrheven.co.kr',:name=>'ad_manager',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>9,:email => 'jpark6@myserheven.co.kr',:name=>'store_manager',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>10,:email => 'jpark7@myserhevwegen.co.kr',:name=>'cs',:password => 'a12345', :password_confirmation => 'a12345')

Role.create(:id=>1,:title=>'관리자',role: 'administrator')
Role.create(:id=>2,:title=>'운영자', role: 'operator')
Role.create(:id=>3,:title=>'보조운영자', role: 'sub_operator')
Role.create(:id=>4,:title=>'알바생', role: 'reader')
Role.create(:id=>5,:title=>'스폰서', role: 'sponsor')
Role.create(:id=>6,:title=>'광고관리자', role: 'ad_manager')
Role.create(:id=>7,:title=>'상점관리자', role: 'store_manager')
Role.create(:id=>8,:title=>'고객상담관리자', role: 'cs_manager')

RoleAdmin.create(:role_id=>1,:admin_id=>1)
RoleAdmin.create(:role_id=>1,:admin_id=>2)
RoleAdmin.create(:role_id=>1,:admin_id=>3)
RoleAdmin.create(:role_id=>2,:admin_id=>4)
RoleAdmin.create(:role_id=>3,:admin_id=>5)
RoleAdmin.create(:role_id=>4,:admin_id=>6)
RoleAdmin.create(:role_id=>5,:admin_id=>7)
RoleAdmin.create(:role_id=>6,:admin_id=>8)
RoleAdmin.create(:role_id=>7,:admin_id=>9)
RoleAdmin.create(:role_id=>8,:admin_id=>10)
...
User.create(:id=>9,:username=>'yjkim',:email => 'yjkim@jedaeroweb.co.kr',:nickname=>'김테스트',:password => '123456', :password_confirmation => '123456',:nation_num=>'86', :mobile_num=>'15800406171',:point=>100000, :coupon=>0, :device_id=>'awegweg', :service_provider=>'010111')
...
User.create(:id=>18,:username=>'yjkimnn',:email => 'yjkim@253jedaeroweb.co.kr',:nickname=>'김테스awe트',:password => '123456', :password_confirmation => '123456',:nation_num=>'86', :mobile_num=>'15800406171',:point=>100000, :coupon=>0, :device_id=>'awegweg', :service_provider=>'010111')
...
User.create(:id=>27,:username=>'yjkiserhseddddm',:email => 'yjk325235im@jedaeroweb.co.kr',:nickname=>'김wega테스트',:password => '123456', :password_confirmation => '123456',:nation_num=>'86', :mobile_num=>'15800406171',:point=>100000, :coupon=>0, :device_id=>'awegweg', :service_provider=>'010111')
...
Bank.create(:title=>'China Mobile')
Bank.create(:title=>'China Unicom')
Bank.create(:title=>'China Telecom')
Bank.create(:title=>'기타')
