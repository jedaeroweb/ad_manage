...
Admin.create(:id=>3,:email => 'user1@jedaeroweb.co.kr',:name=>'Jon Doe1',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>4,:email => 'user2@jedaeroweb.co.kr',:name=>'Operator',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>5,:email => 'user3@jedaeroweb.co.kr',:name=>'SubOperator',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>6,:email => 'user4@jedaeroweb.co.kr',:name=>'Reader',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>7,:email => 'user5@jedaeroweb.co.kr',:name=>'Sponsor',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>8,:email => 'user6@mysrheven.co.kr',:name=>'ad_manager',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>9,:email => 'user7@myserheven.co.kr',:name=>'store_manager',:password => 'a12345', :password_confirmation => 'a12345')
Admin.create(:id=>10,:email => 'user8@myserhevwegen.co.kr',:name=>'cs',:password => 'a12345', :password_confirmation => 'a12345')
